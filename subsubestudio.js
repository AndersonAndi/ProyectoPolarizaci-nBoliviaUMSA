...
console.log("Ruta comentarios:", ruta1);
const ruta2 = `${medio}/${mes}/${dia}/ordParInd.csv`;
console.log("Ruta ordParInd:", ruta2);
const ruta3 = `${medio}/${mes}/${dia}/palabras_por_fila.csv`;
console.log("Ruta palabras_por_fila:", ruta3);
const ruta4 = `${medio}/${mes}/${dia}/totales.csv`;
console.log("Ruta totales:", ruta4);
...
const diasMedios = {
  bolivision: [
    { mes: "Septiembre", m: "septiembre" , dia: 14 }, // -
    { mes: "Septiembre", m: "septiembre" , dia: 16 }, // -
    { mes: "Septiembre", m: "septiembre" , dia: 22 }, // -
    { mes: "Septiembre", m: "septiembre" , dia: 25 }, // -
    { mes: "Octubre", m: "octubre" , dia: 1 }, // -
    { mes: "Octubre", m: "octubre" , dia: 2 }, // -
    { mes: "Octubre", m: "octubre" , dia: 8 }, // -
    { mes: "Octubre", m: "octubre" , dia: 19 } // -
  ],
  pat: [
    { mes: "Septiembre", m: "septiembre" , dia: 14 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 19 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 22 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 27 }, //-
    { mes: "Octubre", m: "octubre" , dia: 3 }, //-
    { mes: "Octubre", m: "octubre" , dia: 4 }, //-
    { mes: "Octubre", m: "octubre" , dia: 6 } //-
  ],
  telepais: [
    { mes: "Septiembre", m: "septiembre" , dia: 14 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 15 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 17 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 23 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 29 }, //-
    { mes: "Octubre", m: "octubre" , dia: 2 }, //-
    { mes: "Octubre", m: "octubre" , dia: 4 } //-
  ],
  notivision: [
    ...
    { mes: "Septiembre", m: "septiembre" , dia: 16 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 17 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 18 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 19 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 20 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 22 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 23 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 25 }, //-
    { mes: "Septiembre", m: "septiembre" , dia: 26 }, //-
    { mes: "Octubre", m: "octubre" , dia: 1 }, //-
    { mes: "Octubre", m: "octubre" , dia: 2 }, //-
    { mes: "Octubre", m: "octubre" , dia: 3 } //-
  ]
...
if (medioID && diasMedios[medioID]) {
  ...
  renderDias(diasMedios[medioID], "diasMedioSeleccionado1");
}
...
function renderDias(lista, contenedorID) {
  ...
  lista.forEach(d => {
    ...
    div.addEventListener("click", () => {
      const url = `subsubestudio.html?medio=${medioID}&mes=${d.m}&dia=${d.dia}`;
...
google.charts.setOnLoadCallback(() => {
  fetch(ruta1)
    ...
    .then(csv => {
      ...
      document.getElementById("cantComentarios").textContent =
        countNeg + countNeu + countPos;
